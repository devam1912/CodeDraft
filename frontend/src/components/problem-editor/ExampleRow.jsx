    ...
    <div className="p-4 bg-bg-surface border border-border-default rounded-xl flex flex-col gap-3 transition-colors duration-200 hover:border-primary relative animate-fade-in">
      ...
      <div>
        ...
        <input
          ...
          className="w-full bg-bg-primary border border-border-default rounded-lg px-3 py-2 text-sm text-text-primary placeholder-text-muted focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors duration-200"
        />
      </div>
    </div>
  );
